...
const OpenCollective = ({className, ...props}) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className={cn("w-4 h-4 bi bi-opencollective", className)} viewBox="0 0 16 16">
